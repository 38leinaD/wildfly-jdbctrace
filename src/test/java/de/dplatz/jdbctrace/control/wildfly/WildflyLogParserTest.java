...
public class WildflyLogParserTest {
    ...
    public void extractFullEvent() {
        ...
        assertThat(stmt.resolvedStatement(), is("UPDATE LEASE SET VALIDTO = '2018-03-22 18:44:19.692', OWNER = 'Alpha.Cluster.dev-vm', PREVIOUSDATA = DATA, DATA = '{\"cat\":\"Default\",\"#\":\"0\",\"msec\":\"1\"}' WHERE PROCESSINGCENTER = 'ALPHA' AND CATEGORY = 'Reprocess-Chunk' AND ID = 'Default/14' AND (VALIDTO < '2018-03-22 18:44:19.692' AND VALIDTO < '2018-03-22 18:44:19.692' OR OWNER = 'Alpha.Cluster.dev-vm')"));
    }
}